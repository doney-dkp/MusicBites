...
android {
    namespace = "com.doney_dkp.music"
    compileSdk = 35
    buildToolsVersion = "35.0.0"
    defaultConfig {
        applicationId = "com.doney_dkp.music"
        minSdk = 24
        targetSdk = 35
        versionCode = 26
        versionName = "1.0.0"
    ...
    signingConfigs {
        ...
        create("release") {
            if (System.getenv("MUSIC_RELEASE_SIGNING_STORE_PASSWORD") != null) {
                storeFile = file(System.getenv("MUSIC_RELEASE_KEYSTORE_FILE"))
                storePassword = System.getenv("MUSIC_RELEASE_SIGNING_STORE_PASSWORD")
                keyAlias = System.getenv("MUSIC_RELEASE_KEY_ALIAS") ?: "release"
                keyPassword = System.getenv("MUSIC_RELEASE_SIGNING_KEY_PASSWORD")
            }
        }
    }
    buildTypes {
