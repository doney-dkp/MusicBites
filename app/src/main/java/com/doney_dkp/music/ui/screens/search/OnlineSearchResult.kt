package com.doney_dkp.music.ui.screens.search
...
import com.dkp.musicbites.YouTube.SearchFilter.Companion.FILTER_ALBUM
import com.dkp.musicbites.YouTube.SearchFilter.Companion.FILTER_ARTIST
import com.dkp.musicbites.YouTube.SearchFilter.Companion.FILTER_COMMUNITY_PLAYLIST
import com.dkp.musicbites.YouTube.SearchFilter.Companion.FILTER_FEATURED_PLAYLIST
import com.dkp.musicbites.YouTube.SearchFilter.Companion.FILTER_SONG
import com.dkp.musicbites.YouTube.SearchFilter.Companion.FILTER_VIDEO
...
import com.doney_dkp.music.constants.SearchFilterHeight
...
import com.doney_dkp.music.viewmodels.OnlineSearchViewModel
...
fun OnlineSearchResult(
    ...
    val allItemsPage = viewModel.allItemsPage
    ...
    LazyColumn(
        ...
        if (searchFilter == null) {
            items(
                items = allItemsPage?.items.orEmpty(),
                key = { it.id },
                itemContent = ytItemContent
            )

            if (allItemsPage?.continuation != null) {
                item(key = "loading") {
                    ShimmerHost {
                        repeat(3) {
                            ListItemPlaceHolder()
            ...
            if (allItemsPage?.items?.isEmpty() == true) {
                item {
                    EmptyPlaceholder(
        ...
        if (searchFilter == null && allItemsPage == null || searchFilter != null && itemsPage == null) {
            item {
                ShimmerHost {
                    repeat(8) {
                        ListItemPlaceHolder()
