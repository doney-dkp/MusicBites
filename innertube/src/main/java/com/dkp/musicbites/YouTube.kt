package com.dkp.musicbites

import com.dkp.musicbites.models.AccountInfo
...
import com.dkp.musicbites.models.MusicCarouselShelfRenderer
import com.dkp.musicbites.models.PlaylistItem
import com.dkp.musicbites.models.SearchSuggestions
import com.dkp.musicbites.models.SongItem
import com.dkp.musicbites.models.WatchEndpoint
import com.dkp.musicbites.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_ATV
import com.dkp.musicbites.models.YouTubeClient
import com.dkp.musicbites.models.YouTubeClient.Companion.WEB
import com.dkp.musicbites.models.YouTubeClient.Companion.WEB_REMIX
import com.dkp.musicbites.models.YouTubeLocale
import com.dkp.musicbites.models.getContinuation
import com.dkp.musicbites.models.oddElements
import com.dkp.musicbites.models.response.AccountMenuResponse
import com.dkp.musicbites.models.response.BrowseResponse
import com.dkp.musicbites.models.response.GetQueueResponse
import com.dkp.musicbites.models.response.GetSearchSuggestionsResponse
import com.dkp.musicbites.models.response.GetTranscriptResponse
import com.dkp.musicbites.models.response.NextResponse
import com.dkp.musicbites.models.response.PlayerResponse
import com.dkp.musicbites.models.response.SearchResponse
import com.dkp.musicbites.pages.AlbumPage
import com.dkp.musicbites.pages.ArtistItemsContinuationPage
import com.dkp.musicbites.pages.ArtistItemsPage
import com.dkp.musicbites.pages.ArtistPage
import com.dkp.musicbites.pages.BrowseResult
import com.dkp.musicbites.pages.ExplorePage
import com.dkp.musicbites.pages.HomePage
import com.dkp.musicbites.pages.MoodAndGenres
import com.dkp.musicbites.pages.NewReleaseAlbumPage
import com.dkp.musicbites.pages.NextPage
import com.dkp.musicbites.pages.NextResult
import com.dkp.musicbites.pages.PlaylistContinuationPage
import com.dkp.musicbites.pages.PlaylistPage
import com.dkp.musicbites.pages.RelatedPage
import com.dkp.musicbites.pages.SearchPage
import com.dkp.musicbites.pages.SearchResult
import com.dkp.musicbites.pages.SearchSuggestionPage
import com.dkp.musicbites.pages.SearchSummary
import com.dkp.musicbites.pages.SearchSummaryPage
...
object YouTube {
    ...
    suspend fun searchAll(query: String): Result<SearchResult> = runCatching {
        val response = innerTube.search(WEB_REMIX, query).body<SearchResponse>()
        SearchResult(
